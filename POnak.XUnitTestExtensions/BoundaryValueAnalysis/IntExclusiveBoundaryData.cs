...
namespace POnak.XUnitTestExtensions.BoundaryValueAnalysis
{
    ...
    /// </summary>
    public class IntExclusiveBoundaryData : DataAttribute
    {
        /// <summary>
        ...
        public IntExclusiveBoundaryData(int low, int high)
        {
            Low = low;
            High = high;
        }
        ...
        {
            var generator = new BoundaryValueAnalysisTestGenerator<int>(Strategy, false);
